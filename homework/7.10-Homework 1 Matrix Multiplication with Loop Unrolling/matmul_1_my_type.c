...
int main(int argc, char *argv[])
{
    ...
    printf("Normal version takes %f seconds to finish the computation.\n\n", elapsed);
...
// printf("******************************************************\n");
    ...
    microseconds = end_time.tv_usec - start_time.tv_usec;
    elapsed = seconds + 1e-6 * microseconds;
    printf("Unrolling version takes %f seconds to finish the computation.\n\n", elapsed);
